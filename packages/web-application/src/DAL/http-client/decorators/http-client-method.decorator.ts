...
const getDescriptorOriginalMethod = <ServiceStrategy extends EHttpClientStrategy>(descriptorValue: Undefinedtable<THttpClientMethod<ServiceStrategy, any>>) => {
    if (!descriptorValue) {
...
const httpClientMethodPromise = (_target: HttpClientPromise, propertyKey: string, descriptor: TypedPropertyDescriptor<THttpClientMethod<EHttpClientStrategy.Promise, any>>) => {
...
const httpClientMethodObservable = (_target: HttpClientObservable, propertyKey: string, descriptor: TypedPropertyDescriptor<THttpClientMethod<EHttpClientStrategy.Observable, any>>) => {
...
export function httpClientMethod(serviceStrategy: EHttpClientStrategy): typeof httpClientMethodPromise | typeof httpClientMethodObservable {
